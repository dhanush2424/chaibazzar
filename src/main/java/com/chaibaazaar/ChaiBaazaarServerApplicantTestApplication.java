package com.chaibaazaar;

import com.chaibaazaar.util.LoggingInterceptor;
...
public class ChaiBaazaarServerApplicantTestApplication extends WebMvcConfigurerAdapter
{

    public static void main(String[] args)
    {
        SpringApplication.run(ChaiBaazaarServerApplicantTestApplication.class, args);
    }
